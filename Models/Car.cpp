...
std::string Car::getCreatedAt() const {
    return createdAt;
}

std::string Car::getUpdatedAt() const {
    return updatedAt;
}
...
void Car::setCreatedAt(const std::string& createdAt) {
    this->createdAt = createdAt;
}

void Car::setUpdatedAt(const std::string& updatedAt) {
